...
- Der **Nino-OS** Bot ist ein MUTI-GUILD Bot, das heißt das er **Command** hat wie z.B: der `/auto publish` command (Der automatisch Nachrichten in ein channel [Ankündungs channel] veröffentlicht), jedoch hat er auch auch mehr wie z.B: ein `/giveaway` 🎉 system und eben so auch ein `/ticket` 🎫 system. Und dies geht auf **mehren** server
